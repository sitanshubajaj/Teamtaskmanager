...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      {projects.length === 0 ? (
        <div className="clean-card text-center" style={{ padding: '2rem' }}>No projects found.</div>
      ) : (
        <motion.div 
        ...
        >
          {projects.map(project => (
            <motion.div variants={itemVariants} key={project._id} style={{ display: 'flex' }}>
              <Link to={`/projects/${project._id}/tasks`} className="clean-card project-card" style={{ width: '100%' }}>
          ...
          >
            ...
            <form onSubmit={handleCreate} className="auth-form">
              ...
              <div className="form-group">
                ...
                <div style={{ maxHeight: '150px', overflowY: 'auto', border: '1px solid var(--border)', padding: '0.5rem', borderRadius: '0.375rem', backgroundColor: 'white' }}>
